...
local menu        = "wofi --conf ~/.config/wofi/config/config --style ~/.config/wofi/src/mocha/style.css"
...
--   hl.exec_cmd("nm-applet")
    hl.exec_cmd("/usr/libexec/polkit-gnome-authentication-agent-1 & hyprpaper & swaync & waybar & nm-applet & blueman")
end)
...
-- Define workspaces with roman numerals for names
...
hl.workspace_rule({ workspace = "9", default_name = "IX" })
...
-- Move through workspaces with ALT + TAB
